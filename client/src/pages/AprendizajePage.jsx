      ...
      <div className="content">
        ...
        <a className="description">
          ...
          <a className="description2">
            ...
            centro de cada cara y marcan el color de la misma. Cada cubo tiene 6
            centros.
          </a>
          <a className="description2">
            Aristas: el cubo 3x3 tiene 12 aristas. Se sitúan entre los vértices
            y están formadas por dos colores. Esquinas: tendremos un total de 8
            esquinas y cada una se compone de tres colores diferentes.
          </a>
        ...
        <a className="description">
          ...
          <a className="description2">
            ...
            serie de algoritmos para no desmontar la parte que ya tenemos hecha.
          </a>
        </a>

        <h2 className="cambio">
          <Link to="/metodop" replace>
            Metodo principiante
          </Link>
        </h2>
      </div>
